...
In the analyses of Caddo bottle morphology [@RN8074;@RN7927;@RN8370;@RN8312], vessels of the same `decorative type` were found to differ in morphology across north-south geography. It is not known whether the same Caddo maker that crafted a vessel's shape also applied the decorative elements; however, if the maker is also assumed to be the decorator, then it may be the case that Caddo vessel shapes and decorative elements incorporate distinct cultural signals, perhaps akin to the _autogenous_ and _adherent_ signals proposed by Kubler [-@RN8105].
