...
```{r 3d.gpa, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# render 3d gpa plot
#plot(Y.gpa)
...
_Hypothesis: Formative/Early and Late/Historic Caddo bottles found north and south of the shape boundary express discrete patterns of shape change._
