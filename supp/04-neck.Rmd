...
```{r gpa.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r box1.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap = "Boxplot of centroid size by spatial/temporal unit."}
...
Principal components analysis [@RN1746] was used to visualise neck shape variation. The shape changes described by each principal axis are commonly visualised using thin-plate spline warping of a reference 3D mesh [@RN1731;@RN479]. 

```{r pca.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# principal components analysis
...
```{r def.mod.1.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# size
...
_Hypothesis: The neck of Formative/Early and Late/Historic Caddo bottles found north and south of the shape boundary express unique patterns of shape change._

### Procrustes ANOVA

```{r h1.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# ANOVA: do Caddo bottle neck sizes differ by geo?
anova(fit.sz.geo)

# ANOVA: do Caddo bottle neck sizes differ by time?
anova(fit.sz.time)

# ANOVA: do Caddo bottle neck shapes differ by geo?
anova(fit.sh.geo)

# ANOVA: do Caddo bottle neck shapes differ by time?
anova(fit.sh.time)

# ANOVA: do Caddo bottle neck sizes differ by geo + time?
anova(fit.size)

# ANOVA: do Caddo bottle neck shapes differ by geo + time?
anova(fit.shape)
```

### Mean Shapes

```{r mshape.h1.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r trajectory.neck, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
