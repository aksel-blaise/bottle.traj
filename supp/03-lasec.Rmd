...
Results demonstrate that nine landmarks are necessary to achieve a median fit value of 0.90, 12 to achieve a median fit value of 0.95, and 28 to achieve a fit value of 0.99. For centroid size, five landmarks were needed to achieve a median fit value of 0.99.
...
Results demonstrate saltation, illustrating that some landmarks are critical for capturing shape information [@RN28913]. Dynamic as Caddo bottles points may be in shape, that variation may be captured with a configuration of landmarks that employed fewer semilandmarks.
